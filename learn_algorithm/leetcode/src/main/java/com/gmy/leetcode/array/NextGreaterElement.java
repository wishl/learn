...
public class NextGreaterElement {
    ...
    public int[] nextGreaterElement(int[] nums1, int[] nums2) {
        ...
        for (int i = nums2.length - 1; i >= 0; i--) {
            ...
            map.put(nums2[i], deque.peek() == null ? -1 : deque.peek());
            deque.push(nums2[i]);
        }
    ...
    public static void main(String[] args) {
        ...
        int[] nums1 = {4, 1, 2};
        int[] nums2 = {1, 0, 3, 4, 2};
        int[] ints = nextGreaterElement.nextGreaterElement1(nums1, nums2);
        int[] ints1 = nextGreaterElement.nextGreaterElement(nums1, nums2);
