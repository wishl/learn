 ...
 * 输出: [1,1,4,2,1,1,0,0]
 */
public class DailyTemperaturesReview {
    ...
    public static void main(String[] args) {
        DailyTemperaturesReview review = new DailyTemperaturesReview();
        int[] result = review.dailyTemperatures(new int[]{73, 74, 75, 71, 69, 72, 76, 73});
